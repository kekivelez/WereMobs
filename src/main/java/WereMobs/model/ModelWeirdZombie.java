...
public class ModelWeirdZombie extends ModelBase {
    ...
    public ModelWeirdZombie ()
    {
        this(1.6F);
    }

    public ModelWeirdZombie(float par1)
    {
        textureWidth = 128;
        textureHeight = 128;
        ...
        horn.setRotationPoint(-1F, -11F, -4F);
        horn.setTextureSize(128, 128);
        horn.mirror = true;
        setRotation(horn, 0.3717861F, 0F, 0F);
    }
